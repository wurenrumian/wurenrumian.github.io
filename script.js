...
`
                },
                {
                    title:"缩小的社会",
                    content: `
这个社会，正在无声地缩小，而人们，也在不断地退缩，成了自己囚禁自己的“缩人”。

我们看到的，低头已难以窥见社会的底层，抬头却只能望见那有限的天花板，眼界的极限愈加逼仄。  
我们听到的，不再需要信息茧房，整个人的注意力早已被互联网吸附，难以挣脱。  
我们听闻的，只能停留在一个楼层，阶级之间的声音早已隔绝，无法相通。  
我们思考的，梦想逐渐被每日的餐饭与无休的 996 所取代，奋斗竟然成了新的梦想。  
我们选择的，高考仿佛成了考公、考研的预演，选择的空间逐渐重叠，难以辨别出口。  
我们思虑的，基本的人权与人性已不再优先，生存和出路成了压倒一切的任务。  
我们追求的，变得愈加平凡，平淡的生活被视为最高的理想，渴望的边界一步步收缩。  
我们感受的，个人的小天地似乎已吞噬一切，孤独与自足在这狭隘的空间中共生。  
我们容纳的，一条路上已难以容下我们的不满，声音变得愈发微弱。  
我们热爱的，早已成了生活的附属品，曾经的炙热与深刻被时间悄然磨平。  
我们能做的，能力与影响力在缩小中逐渐消散，力量如风中的尘埃般无力。  
我们享受的，多彩的体验被单调的节奏所取代，选择的空间越来越狭窄，甚至消失殆尽。  
我们记忆的，童年的无忧与往昔的快乐逐渐模糊，仿佛隔着一层厚重的雾霾。  
我们阅读的，知识要么在过去夭折，要么在未来消亡，难以穿越时间的屏障。  
我们敢于尝试的，勇气在日渐减少，稳定成了唯一的信仰，风险比斗争更为可怕。  
我们表达的，言语与思想在小圈子里徘徊，真实的自我与意见被层层过滤，难以显现。  
我们交往的，人际关系日趋表面化，深度与联系逐渐稀薄，真诚的互动正在消退。  
我们渴望的，曾经脑海中沉重的巨石，如今只剩下轻飘飘的尘埃。
...
`
                ...
                {
                    title: "成为超级个体，难了还是简单了？",
                    content: `
有人说，超级个体的时代过去了，现在的个人自媒体，已经无法再像几年前般辉煌起来了。
但是也有人说，在AI的加持下超级个体的时代才刚刚到来。

首先可以确定的是，一个胡乱创作就可以获利的时代已经过去了，哪怕是去年，AI撰写的文章也可以轻松爆火。但是如今，除非你比较用心用脑地创作，否则根本获得不了平台的流量。凭直觉就能赚钱已经不再可能。
现在创作的门槛和所需的认知让一个非常普通的人，很难成为超级个体。
这就是为什么有人说超级个体的时代过去了。

那为什么有人说超级个体的时代又来了呢？
原理非常简单，主语不同。对于上文所说的普通人，那个超级个体的时代已经完全过去了。但是对于哪些“不普通”的人，在AI的加持的情况下，超级个体时代才刚刚开始。

“普通”和“不普通”的概念很笼统，我们应加以定义。

“普通”和“不普通”是能力种类差异吗？电工，教师，码农，他们都有不同种类的能力，但是在我们眼里，他们都是普通人。
“普通”和“不普通”是能力强弱差异吗？好像是的，比如说大厂人工智能算法工程师和openai的研发岗位，在我们印象里，前者是能力比较强的普通人，后者则可以算是行业的大师。
普通不普通，或许应该从我们的目的来看。在超级个体的层面，现有情况可以成为超级个体的应该算是“不普通”的人，暂时成为不了超级个体的应该算是“普通人”。
那“普通”人和“不普通”人的差别在哪里？
我们可以把创作描述成以下几个过程
1. 体察需求
2. 酝酿构思
3. 初步创作
4. 改进循环
普通人和不普通的人的差异就体现在这四个方面上。

|      | 普通人              | 不普通人            |
| ---- | ---------------- | --------------- |
| 体察需求 | 活在成见，感知力逐渐变得麻木   | 打破成见，探索成见下的世界   |
| 酝酿构思 | 难以深刻分析           | 善于深刻分析          |
| 初步创作 | 创作结构未成为前知识       | 创作结构已成为前知识      |
| 改进循环 | 对现状和理想的感知力弱，品味平庸 | 对现状和理想的感知力强，品位高 |
...
假如我写下一段文字，发表我的见解。如果说我想发表在纯文本平台，那很简单，更改一下措辞即可。如果我想发在图文平台，那可能还要再在网上找几个图，或者自己绘制。如果我想发在视频平台，那我可能说要自己露个脸或者自己去制作视频，制作视频需要学会剪辑、制作动画、配音、特效等等等等。如果说我要发在音频平台，那我可能自己配音，或者要找个人帮我配音，还有修改文字内容，使之符合广播稿的特点。
如果说我还想让这个内容为我带来足够多的流量，那我还需要转发，分享，配上专门的文字。

你会发现，就一段文字，就要配上许许多多的内容。

这一段文字，就是我创作的内核，而其他的所有操作，都是我创作的外围。

所以现在理解这种差距了吗？

“不普通”人的创作能力更强，有坚实的创作内核，而“普通”人的创作能力更弱，创作内核几乎没有。
而AI对我们的加持，恰恰体现在创作的外围上。

这就是超级个体时代悖论的真相。

想要成为超级个体，首先要提升自己的各种创作能力，脱离平庸。
